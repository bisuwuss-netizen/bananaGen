          ...
          {isEditing ? (
            ...
            <div className="space-y-3" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  onClick={handleSave}
                  className="px-3 py-1.5 text-sm bg-banana-500 text-white rounded-lg hover:bg-banana-600 transition-colors"
                >
        ...
        {!isEditing && (
          <div className="flex-shrink-0 flex gap-2">
            <button
              ...
              className="p-1.5 text-gray-500 hover:text-banana-500 hover:bg-banana-50 rounded transition-colors"
            >
              <Edit2 size={16} />
            </button>
            <button
