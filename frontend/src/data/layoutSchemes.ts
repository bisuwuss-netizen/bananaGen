...
export interface LayoutScheme {
  ...
  tags: string[];
  accent: string;
  collections: Array<'ai_recommended' | 'classroom' | 'academic' | 'brand'>;
...
export const layoutSchemes: LayoutScheme[] = [
  {
    ...
    tags: ['教育', '深色', '叙事'],
    accent: '#06b6d4',
    collections: ['ai_recommended', 'classroom', 'academic'],
  ...
  },
  {
    ...
    tags: ['技术', '发布', '清晰'],
    accent: '#0f4c81',
    collections: ['ai_recommended', 'brand'],
  ...
  },
  {
    ...
    tags: ['学术', '研究', '严谨'],
    accent: '#334155',
    collections: ['ai_recommended', 'academic'],
  ...
  },
  {
    ...
    tags: ['互动', '课堂', '引导'],
    accent: '#1d9bf0',
    collections: ['ai_recommended', 'classroom'],
