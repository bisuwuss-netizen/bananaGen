...
def _base_runtime_config() -> dict[str, Any]:
    return {
        ...
        "IMAGE_REQUEST_MIN_INTERVAL_SECONDS": fastapi_settings.image_request_min_interval_seconds,
        "QWEN_IMAGE_MIN_INTERVAL_SECONDS": fastapi_settings.qwen_image_min_interval_seconds,
        "QWEN_IMAGE_MAX_WORKERS": fastapi_settings.qwen_image_max_workers,
