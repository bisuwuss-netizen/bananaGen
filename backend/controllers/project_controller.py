...
def generate_outline(project_id):
    ...
    try:
        ...
        pedagogy_method = data.get('pedagogy_method', 'five_step')  # 默认五步教学法
        ...
        if project.creation_type == 'outline':
            ...
            project_context = ProjectContext(project, reference_files_content, practice_ratio=practice_ratio, pedagogy_method=pedagogy_method)
